...
/**
 * B_Item_List_Selection
 *
 * @ORM\Table(name="b__item__list__selection")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\B_Item_List_SelectionRepository")
 */
class B_Item_List_Selection
{
    /**
     * @var int
     *
    ...
    /**
     *@ORM\ManyToOne(targetEntity="B_Question", inversedBy="items_list_selection")
