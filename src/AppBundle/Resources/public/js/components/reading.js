const Reading = {
    template: `
<div id="habilidad" class="reading row form-panel">
...
<router-link v-bind:to="enrutar(3)">Go to Foo</router-link>
<router-link to="/2"><button>Go to Foo</button></router-link>
</div>
`,
name: 'reading',
    data: function() {
